...
//filestore/stores/configs
export * from './filestore/stores/configs/item-store';
export * from './filestore/stores/configs/npc-store';
export * from './filestore/stores/configs/object-store';
...
//filestore/util
export * from './filestore/util/name-hash';
