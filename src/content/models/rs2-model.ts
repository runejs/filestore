...
export class Rs2Model {
    ...
    public texturedFaceCount: number;
    public verticesX: number[];
    public verticesY: number[];
    public verticesZ: number[];
    public faceIndicesA: Uint16Array;
    public faceIndicesB: Uint16Array;
    public faceIndicesC: Uint16Array;
    public texturedFaceTypes: Uint8Array;
    public texturedFaceIndicesA: Uint16Array;
    public texturedFaceIndicesB: Uint16Array;
    public texturedFaceIndicesC: Uint16Array;
    public vertexSkins: number[];
    public faceTypes: Uint32Array;
    public texturedFaceTypeIndices: Int8Array;
    public faceTextures: Int8Array;
    public facePriorities: Uint8Array;
    public facePriority: number;
    public faceAlphas: Uint8Array;
    public faceSkins: number[];
    public faceColors: Uint32Array;
    public faceTextureU: number[][];
    public faceTextureV: number[][];
    public faceColorsX: Uint32Array;
    public faceColorsY: Uint32Array;
    public faceColorsZ: Uint32Array;
    public vertexNormals: VertexNormal[];
    public vertexNormalOffsets: VertexNormal[];
    public anInt3193: number;
    ...
    public applyLighting(ambient: number, contrast: number, arg2: number,
    ...
    public applyShading(arg0: number, arg1: number, arg2: number,
